package com.tcl.marketing.coupon.service.resource.impl;
...
import com.tcl.marketing.coupon.dal.dataobject.CouponResourceTerinalDO;
import com.tcl.marketing.coupon.service.resource.CouponResourceOpsService;
import com.tcl.marketing.coupon.service.resource.CouponResourceQueryService;
import com.tcl.marketing.coupon.service.resource.bo.*;
...
public class CouponResourceOpsServiceImpl implements CouponResourceOpsService {
    ...
    public int addIfExistUpdate(CouponResourceBO resourceBO, CouponResourceTerminalBO resourceTerminalBO, CouponResourceBizBO resourceBizBO, CouponResourceRuleBO resourceRuleBO) {
        ...
        CouponResourceTerinalDO resourceTerinalDO = null;
    ...
    private int add(CouponResourceDO resourceDO, CouponResourceBizDO resourceBizDO, CouponResourceTerinalDO resourceTerinalDO, CouponResourceRuleDO resourceRuleDO) {

        return 0;
    }

    private int update(CouponResourceDO resourceDO, CouponResourceBizDO resourceBizDO, CouponResourceTerinalDO resourceTerinalDO, CouponResourceRuleDO resourceRuleDO) {
